...
exports.AmazonDe = {
    ...
    links: [
        ...
        {
            brand: 'microsoft',
            cartUrl: 'https://www.amazon.de/gp/aws/cart/add.html?ASIN.1=B08H93ZRLL&Quantity.1=1',
            labels: {
                inStock: {
                    container: '#productTitle',
                    text: ['Xbox Series X'],
        ...
        {
            brand: 'microsoft',
            cartUrl: 'https://www.amazon.de/gp/aws/cart/add.html?ASIN.1=B087VM5XC6&Quantity.1=1',
            labels: {
                inStock: {
                    container: '#productTitle',
                    text: ['Xbox Series S'],
